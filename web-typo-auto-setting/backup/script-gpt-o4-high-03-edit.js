...
function updateStyles() {
  ...
  // H1: remove inline line-height, only adjust margin-bottom
  h1Els.forEach(el => {
  ...
  h2Els.forEach(el => {
    ...
    el.style.borderLeft = h2BorderInput.checked ? `4px solid ${h2ColorInput.value}` : 'none';
  });
  ...
  // Body paragraphs keep normal line-height
  pEls.forEach(el => {
